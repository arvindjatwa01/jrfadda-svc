 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post("/", examsCategoryController.createExamCategory);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.put("/:id", examsCategoryController.updateExamCategory);
